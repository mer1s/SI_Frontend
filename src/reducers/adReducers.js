import { AD_CREATE_FAIL, AD_CREATE_REQ, AD_CREATE_RESET, AD_CREATE_SUCCESS, AD_DELETE_FAIL, AD_DELETE_REQ, AD_DELETE_SUCCESS, AD_UPDATE_FAIL, AD_UPDATE_REQ, AD_UPDATE_RESET, AD_UPDATE_SUCCESS, GET_ADS_FAIL, GET_ADS_REQUEST, GET_ADS_SUCCESS, GET_NEW_ADS_FAIL, GET_NEW_ADS_REQUEST, GET_NEW_ADS_SUCCESS, GET_SINGLE_AD_FAIL, GET_SINGLE_AD_REQUEST, GET_SINGLE_AD_SUCCESS, GET_ST_ADS_FAIL, GET_ST_ADS_REQUEST, GET_ST_ADS_SUCCESS, GET_USERS_ADS_FAIL, GET_USERS_ADS_REQUEST, GET_USERS_ADS_SUCCESS } from "../constants/addConstants";
...
export const getSingleReducer = (state = { loading: true,  ad : { images : [] }}, action)=>{
    switch(action.type){
...
export const deleteAdReducer = (state = { loading: true, }, action) => {
    switch(action.type){
        case AD_DELETE_REQ:
            return {loading: true};
